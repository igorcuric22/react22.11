...
const all=()=>{
    ...
    document.querySelector(".buttons1").classList.add("active");
}
...
const checked=()=>{
    ...
    document.querySelector(".active")?.classList.remove("active");
    document.querySelector(".buttons2").classList.add("active");
...
const notChecked=()=>{
    ...
    document.querySelector(".active")?.classList.remove("active");
    document.querySelector(".buttons3").classList.add("active");
}
